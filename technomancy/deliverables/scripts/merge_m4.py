...
def main() -> None:
    ...
    _ensure_exists(package_src, "staged package directory")
    ...
    # Clean staging directories used during the milestone execution
    if package_src.exists():
        shutil.rmtree(package_src)
    if STAGING_TESTS.exists():
        shutil.rmtree(STAGING_TESTS)

    print("Merge M4 complete.")
